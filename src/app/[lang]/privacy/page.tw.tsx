      ...
      <div className="container mx-auto py-12 md:py-24 px-4 md:px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-gray dark:prose-invert max-w-none">
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4">2. 我們收集的資料</h2>
            <p>我們可能收集以下類型的資料：</p>
            <ul className="list-disc pl-6 mb-6">
              <li>
                <strong>個人識別資訊</strong>：包括姓名、電子郵件地址、電話號碼、郵寄地址等。
              </li>
              <li>
                <strong>商業資訊</strong>：包括公司名稱、職位、業務需求等。
              </li>
              <li>
                <strong>技術資訊</strong>：包括IP地址、瀏覽器類型、設備資訊、訪問時間等。
              </li>
              <li>
                <strong>使用資料</strong>：包括您如何使用我們的網站、產品和服務的資訊。
              </li>
            </ul>

            <h2 className="text-2xl font-semibold mt-8 mb-4">3. 我們如何收集資料</h2>
            <p>我們通過以下方式收集資料：</p>
            <ul className="list-disc pl-6 mb-6">
              <li>
                <strong>直接互動</strong>：當您填寫表單、訂閱我們的服務、請求資料或與我們聯繫時。
              </li>
              <li>
                <strong>自動技術</strong>：當您使用我們的網站時，我們可能會自動收集技術資料。
              </li>
              <li>
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4">4. 我們如何使用您的資料</h2>
            <p>我們使用您的資料的目的包括：</p>
            <ul className="list-disc pl-6 mb-6">
              <li>提供和管理我們的產品和服務</li>
              <li>改進我們的網站、產品和服務</li>
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4">5. 資料共享與披露</h2>
            <p>
              我們可能與以下各方共享您的個人資料：
            </p>
            <ul className="list-disc pl-6 mb-6">
            ...
            <p>
              我們使用 Cookie 和類似技術來提升您的瀏覽體驗、分析網站流量和個性化內容。您可以通過瀏覽器設置控制 Cookie 的使用。
            </p>

            <h2 className="text-2xl font-semibold mt-8 mb-4">10. 隱私政策的變更</h2>
            <p>

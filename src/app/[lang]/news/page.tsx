...
export default async function NewsPage({ params }: PageProps) {
  ...
  const newsItems = [
    {
      ...
      date: "2025-01-15",
      excerpt:
        "Our new platform offers enhanced security features and improved performance for enterprise clients.",
    ...
    },
    {
      ...
      date: "2024-12-10",
      excerpt:
        "We're excited to announce our new partnership with Tech University to develop cutting-edge cloud solutions.",
    ...
    },
    {
      ...
      date: "2024-11-05",
      excerpt:
        "Industry analysts have recognized Arcstratus as a top provider of cloud solutions for the third consecutive year.",
    ...
    },
    {
      ...
      date: "2024-10-20",
      excerpt:
        "We're expanding our global presence with a new office in Singapore to better serve our APAC clients.",
    ...
    },
    {
      ...
      date: "2024-09-15",
      excerpt:
        "We're proud to announce that we have achieved ISO 27001 certification for our information security management system.",
    ...
    },
    {
      ...
      date: "2024-08-01",
      excerpt:
        "Our new suite of DevOps automation tools helps teams streamline their development and deployment processes.",
  ...
  const formatDate = (dateString: string) => {
    ...
    return new Intl.DateTimeFormat(
      resolvedParams.lang === "en" ? "en-US" : "zh-TW",
      {
        year: "numeric",
        month: "long",
        day: "numeric",
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
            {newsItems.map((item) => (
              <Card key={item.id} className="flex flex-col h-full">
                ...
                <CardFooter>
                  <Link href={`/${resolvedParams.lang}/news/${item.slug}`}>

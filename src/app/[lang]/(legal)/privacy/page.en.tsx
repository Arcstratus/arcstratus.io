      ...
      <div className="container mx-auto py-12 md:py-24 px-4 md:px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-gray dark:prose-invert max-w-none">
            ...
            <p>
              Arcstratus (hereinafter referred to as "we," "our," or "the
            ...
            <p>
              ...
              practices regarding your personal data. By using our services, you
            ...
            <ul className="list-disc pl-6 mb-6">
              <li>
                <strong>Personal Identification Information</strong>: Including
                name, email address, phone number, postal address, etc.
              </li>
              <li>
                <strong>Business Information</strong>: Including company name,
                job title, business needs, etc.
              </li>
              <li>
                <strong>Technical Information</strong>: Including IP address,
                browser type, device information, access times, etc.
              </li>
              <li>
            ...
            <ul className="list-disc pl-6 mb-6">
              <li>
                <strong>Direct Interactions</strong>: When you fill out forms,
                subscribe to our services, request information, or contact us.
              </li>
              <li>
                <strong>Automated Technologies</strong>: When you use our
                website, we may automatically collect technical data.
              </li>
              <li>
            ...
            <ul className="list-disc pl-6 mb-6">
              ...
              <li>
                Sending you relevant marketing information (if you have opted
                in)
              </li>
            ...
            <p>
              Under applicable data protection laws, you may have the following
              rights:
            </p>
            <ul className="list-disc pl-6 mb-6">
            ...
            <p>
              ...
              any changes on our website and notify you of significant changes.
            </p>

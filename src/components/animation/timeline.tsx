...
const TimelineEvent = ({ item, index }: { item: Event; index: number }) => {
                  ...
                  <div className="flex items-center text-sm text-muted-foreground mt-1">
                    <IconCheck
                      className={`w-4 h-4 mr-1 ${
                        item.isChecked ? "text-green-500" : "text-gray-400"
                      }`}
                    />
                    ...
                    <div className="px-6 pb-6 pt-2 border-t border-border/50">
                      <div className="mb-4">
                        <h4 className="text-sm font-semibold flex items-center mb-2">
                          <IconBriefcase className="w-4 h-4 mr-2 text-primary" />
                          Events
                        </h4>
...
export const Timeline = ({ title, description, events }: TimelineProps) => {
  return (
